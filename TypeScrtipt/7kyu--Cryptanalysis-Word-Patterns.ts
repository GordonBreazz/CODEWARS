/***********************************************************************************************************************************************************
*     KATA: 7 kyu "Cryptanalysis Word Patterns"
*   Source: https://www.codewars.com/kata/5f3142b3a28d9b002ef58f5e
*   Author: https://www.codewars.com/users/GordonBreazz
*
*     PLOT: In cryptanalysis, words patterns can be a useful tool in cracking simple ciphers.
*     A word pattern is a description of the patterns of letters occurring in a word, where each 
*     letter is given an integer code in order of appearance. So the first letter is given the code 0, 
