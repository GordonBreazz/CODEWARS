#######################################################################################################################################################################################################################################
# 
#     KATA: 6 kyu "Equal Sides Of An Array"
#
#   SOURCE: https://www.codewars.com/kata/5679aa472b8f57fb8c000047
#   AUTHOR: https://www.codewars.com/users/GordonBreazz
# 
#     PLOT: You are going to be given an array of integers. Your job is to take that array and find an index N where 
...
#           at the 3rd position of the array, the sum of left side of the index ({1,2,3}) and the sum of the right 
#           side of the index ({3,2,1}) both equal 6.
#           Let's look at another one.
#           You are given the array {1,100,50,-51,1,1}: Your function will return the index 1, because at 
#           the 1st position of the array, the sum of left side of the index ({1}) and the sum of the right 
