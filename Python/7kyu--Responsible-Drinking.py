#######################################################################################################################################################################################################################################
# 
#     KATA: 7 kyu "Responsible Drinking"
#
#   SOURCE: https://www.codewars.com/kata/5aee86c5783bb432cd000018
#   AUTHOR: https://www.codewars.com/users/GordonBreazz
# 
#     PLOT: Welcome to the Codewars Bar!
...
def hydrate(drink_string): 
    # your code here
    arr = []
    for item in drink_string.split(","):
      arr += [int(s) for s in item.split() if s.isdigit()]    
    result = sum(arr)
    if result > 1:
