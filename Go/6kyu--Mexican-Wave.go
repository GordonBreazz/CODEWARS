/***************************************************************************************************************************************************************************************************************************************
 *
 *     KATA: 6 kyu "Mexican Wave"
 *
 *   SOURCE: https://www.codewars.com/kata/58f5c63f1e26ecda7e000029
 *   AUTHOR: https://www.codewars.com/users/GordonBreazz
 *
 *     PLOT: The wave (known as the Mexican wave in the English-speaking world outside North America) is an
...
func wave(words string) []string {
	...
	for i, item := range words {
		...
		ch := string(item)
		arr = append(arr, st+strings.ToUpper(ch)+words[i+1:])
		st += ch
	}
	return arr
}
