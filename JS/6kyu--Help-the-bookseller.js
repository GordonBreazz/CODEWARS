/***************************************************************************************************************************************************************************************************************************************
* 
*     KATA: 6 kyu "Help the bookseller !"
*
*   SOURCE: https://www.codewars.com/kata/54dc6f5a224c26032800005c
*   AUTHOR: https://www.codewars.com/users/GordonBreazz
* 
*     PLOT: A bookseller has lots of books classified in 26 categories labeled A, B, ... Z. Each book has a code 
...
function stockList(listOfArt, listOfCat){
    ...
    for (let item of listOfArt) {
      let arr = item.split(' ')
      if (typeof dic[arr[0][0]] !== 'undefined') dic[arr[0][0]] += Number(arr[1])
        else dic[arr[0][0]] = Number(arr[1]) 
    } 
    return listOfCat.map( (item) => '('  + item + ' : ' + (dic[item] || 0) + ')' ).join(' - ')
  }
