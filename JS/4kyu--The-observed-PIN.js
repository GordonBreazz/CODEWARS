/***********************************************************************************************************************************************************
*     KATA: 4 kyu "The observed PIN"
*   Source: https://www.codewars.com/kata/5263c6999e0f40dee200059d
*   Author: https://www.codewars.com/users/GordonBreazz
*
*     PLOT: Alright, detective, one of our colleagues successfully observed our target person, Robby the robber. We followed him to a secret warehouse, where 
*           we assume to find all the stolen stuff. The door to this warehouse is secured by an electronic combination lock. Unfortunately our spy isn't sure 
...
function around(st, digits, result){
    if (digits.length == 0)
      return result.push(st)
    for (let ch of digits[0])
      around(st + ch, digits.slice(1), result)
    return result
  }
  
  function getPINs(observed) {
    // TODO: This is your job, detective!
    const dic = ['08', '124', '2135', '326', '4157', '52468', '6359', '748', '80579', '968']  
    let digits = [], result = []
    for (let ch of String(observed))
      digits.push( dic[Number(ch)] )
