...
*
*     PLOT: Pete likes to bake some cakes. He has some recipes and ingredients. Unfortunately he 
*           is not good in maths. Can you help him to find out, how many cakes he could bake considering his recipes?
*
...
function cakes(recipe, available) {
    ...
    while (true) {    
      for (key in recipe){
        if ( !(key in available) ) return c
        available[key] -= recipe[key] 
        if (available[key] < 0)  return c      
      }
      c++
    }
  }
